...
var format_kalialang_poly_6 = new ol.format.GeoJSON();
var features_kalialang_poly_6 = format_kalialang_poly_6.readFeatures(json_kalialang_poly_6, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_kalialang_poly_6 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_kalialang_poly_6.addFeatures(features_kalialang_poly_6);
var lyr_kalialang_poly_6 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_kalialang_poly_6, 
                style: style_kalialang_poly_6,
                popuplayertitle: "kalialang_poly",
                interactive: true,
                title: '<img src="styles/legend/kalialang_poly_6.png" /> kalialang_poly'
            });
var format_kalialang_line_7 = new ol.format.GeoJSON();
var features_kalialang_line_7 = format_kalialang_line_7.readFeatures(json_kalialang_line_7, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_kalialang_line_7 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_kalialang_line_7.addFeatures(features_kalialang_line_7);
var lyr_kalialang_line_7 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_kalialang_line_7, 
                style: style_kalialang_line_7,
                popuplayertitle: "kalialang_line",
                interactive: true,
                title: '<img src="styles/legend/kalialang_line_7.png" /> kalialang_line'
            });
var format_kalialang_point_8 = new ol.format.GeoJSON();
var features_kalialang_point_8 = format_kalialang_point_8.readFeatures(json_kalialang_point_8, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_kalialang_point_8 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_kalialang_point_8.addFeatures(features_kalialang_point_8);
var lyr_kalialang_point_8 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_kalialang_point_8, 
                style: style_kalialang_point_8,
                popuplayertitle: "kalialang_point",
                interactive: true,
                title: '<img src="styles/legend/kalialang_point_8.png" /> kalialang_point'
            });
var format_ADMINISTRASIDESA_AR_25Kcopy_9 = new ol.format.GeoJSON();
var features_ADMINISTRASIDESA_AR_25Kcopy_9 = format_ADMINISTRASIDESA_AR_25Kcopy_9.readFeatures(json_ADMINISTRASIDESA_AR_25Kcopy_9, 
            {dataProjection: 'EPSG:4326', featureProjection: 'EPSG:3857'});
var jsonSource_ADMINISTRASIDESA_AR_25Kcopy_9 = new ol.source.Vector({
    attributions: ' ',
});
jsonSource_ADMINISTRASIDESA_AR_25Kcopy_9.addFeatures(features_ADMINISTRASIDESA_AR_25Kcopy_9);
var lyr_ADMINISTRASIDESA_AR_25Kcopy_9 = new ol.layer.Vector({
                declutter: false,
                source:jsonSource_ADMINISTRASIDESA_AR_25Kcopy_9, 
                style: style_ADMINISTRASIDESA_AR_25Kcopy_9,
                popuplayertitle: "ADMINISTRASIDESA_AR_25K copy",
                interactive: true,
                title: '<img src="styles/legend/ADMINISTRASIDESA_AR_25Kcopy_9.png" /> ADMINISTRASIDESA_AR_25K copy'
            });
...
lyr_ADMINISTRASIDESA_AR_25K_0.setVisible(true);lyr_AGRISAWAH_AR_25K_1.setVisible(true);lyr_PEMUKIMAN_AR_25K_2.setVisible(true);lyr_SARANAIBADAH_PT_25K_3.setVisible(true);lyr_PENDIDIKAN_PT_25K_4.setVisible(true);lyr_PEMERINTAHAN_PT_25K_5.setVisible(true);lyr_kalialang_poly_6.setVisible(true);lyr_kalialang_line_7.setVisible(true);lyr_kalialang_point_8.setVisible(true);lyr_ADMINISTRASIDESA_AR_25Kcopy_9.setVisible(true);lyr_kesehatan_10.setVisible(true);
var layersList = [lyr_ADMINISTRASIDESA_AR_25K_0,lyr_AGRISAWAH_AR_25K_1,lyr_PEMUKIMAN_AR_25K_2,lyr_SARANAIBADAH_PT_25K_3,lyr_PENDIDIKAN_PT_25K_4,lyr_PEMERINTAHAN_PT_25K_5,lyr_kalialang_poly_6,lyr_kalialang_line_7,lyr_kalialang_point_8,lyr_ADMINISTRASIDESA_AR_25Kcopy_9,lyr_kesehatan_10];
...
lyr_SARANAIBADAH_PT_25K_3.set('fieldImages', {'NAMOBJ': 'TextEdit', 'LUAS': 'TextEdit', 'FGSIBD': 'TextEdit', 'FCODE': 'TextEdit', 'REMARK': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', });
lyr_PENDIDIKAN_PT_25K_4.set('fieldImages', {'NAMOBJ': 'TextEdit', 'LUAS': 'TextEdit', 'KATPDK': 'TextEdit', 'JLPDDK': 'TextEdit', 'FGGPDK': 'TextEdit', 'REMARK': 'TextEdit', 'FCODE': 'TextEdit', 'SRS_ID': 'TextEdit', 'LCODE': 'TextEdit', 'METADATA': 'TextEdit', 'JJGPDF': 'TextEdit', 'JNSPDL': 'TextEdit', });
